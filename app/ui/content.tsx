...
export default function Content() {
  return (
    <article className="flex flex-col">
      <h4 className="text-left">1. 가평의 대표 명소, 남이섬</h4>
      <Image
      ...
      <p className="text-center">
        남이섬은 가평의 대표적인 관광지로, 아름다운 자연경관과 다양한 액티비티를
      ...
      <h4 className="text-left">2. 아름다운 자연 속에서의 힐링, 아침고요수목원</h4>
      <Image
        src="/image-sample.webp"
        alt="sample image"
        width={500}
      ...
      />
      <p className="text-center">
        아침고요수목원은 사계절 내내 다양한 꽃과 나무들이 어우러진 아름다운
      ...
      <h4 className="text-left">3. 전통과 현대가 어우러진 가평 쁘띠프랑스</h4>
      <Image
        src="/image-sample.webp"
        alt="sample image"
        width={500}
      ...
      />
      <p className="text-center">
        쁘띠프랑스는 프랑스의 작은 마을을 재현한 테마파크로, 아기자기한 건물들과
